...
class Walker_Nav_Menu extends \Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        // Link classes for desktop and mobile
        $link_class = 'block px-4 py-2 text-gray-700 hover:text-primary-600 transition-colors font-medium lg:inline-block';
    ...
    public function start_lvl(&$output, $depth = 0, $args = null) {
        ...
        // Submenu classes
        $output .= "\n$indent<ul class=\"absolute left-0 top-full mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 lg:block hidden\">\n";
    }
