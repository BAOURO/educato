...
<section class="hero-section">
    ...
    <div class="relative container-custom py-16 lg:py-24">
        <div class="max-w-3xl">
            <h1 class="text-3xl lg:text-5xl font-bold mb-4 animate-fade-in-up">
                <?php bloginfo('name'); ?>
            </h1>
            <p class="text-lg lg:text-xl text-primary-100 mb-6 animate-fade-in-up" style="animation-delay: 0.2s;">
                <?php bloginfo('description'); ?>
            </p>
            <div class="flex flex-col sm:flex-row gap-3 animate-fade-in-up" style="animation-delay: 0.4s;">
                <a href="#content" class="btn btn-secondary">
                    <?php _e('Découvrir', 'educato'); ?>
                </a>
                <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" class="btn bg-white/10 text-white hover:bg-white/20 border border-white/20 hover:shadow-lg">
    ...
    <!-- Decorative elements -->
    <div class="hero-decoration absolute top-0 right-0 w-1/3 h-full opacity-10">
...
<!-- Main Content -->
<div id="content" class="main-content container-custom section-spacing">
    <div class="content-grid grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
        <!-- Content Area -->
        <main class="lg:col-span-3">
            <?php if (have_posts()): ?>
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-1"><?php _e('Dernières actualités', 'educato'); ?></h2>
...
<section class="bg-gray-50 section-spacing">
    <div class="container-custom">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-3"><?php _e('Nos Services', 'educato'); ?></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card text-center p-6">
                ...
                <h3 class="text-xl font-semibold mb-2"><?php _e('Formation', 'educato'); ?></h3>
            ...
            <div class="card text-center p-6">
                ...
                <h3 class="text-xl font-semibold mb-2"><?php _e('Recherche', 'educato'); ?></h3>
            ...
            <div class="card text-center p-6">
                ...
                <h3 class="text-xl font-semibold mb-2"><?php _e('Communauté', 'educato'); ?></h3>
